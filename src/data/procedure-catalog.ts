    ...
    subgroups: [
      {
        ...
        items: [
          { name: '모노폴라 / 바이폴라 RF', note: '진피 가열을 통한 탄력·리프팅 보조' },
          { name: '집속형·고밀도 RF', note: '지방층 가열을 통한 윤곽·탄력 (브랜드별 상이)' },
          { name: '마이크로니들 RF', note: '미세침과 RF 병합 — 모공·흉터·탄력' },
          { name: '바디 RF', note: '체선·셀룰라이트 보조 (개인차)' },
          { name: 'RF 미세혈관·홍조 보조', note: '장비별 적응' },
      ...
      },
      {
        ...
        items: [
          { name: 'HIFU 리프팅', note: 'SMAS·지방막층 수준 에너지 — 윤곽·처짐 보조' },
      ...
      },
      {
        title: '레이저 — 색소 · 문신',
        items: [
          { name: '레이저 토닝', note: 'QS·피코 등 병합 — 색소·피부톤' },
          { name: 'Q-스위치 Nd:YAG', note: '오타·문신·일부 색소' },
          { name: '피코초·나노초 레이저', note: '기미·잡티·문신 세척 등' },
          { name: 'IPL / 포토페이셜', note: '색소·홍조·피부톤 복합' },
      ...
      },
      {
        title: '레이저 — 혈관 · 홍조 · 비립종',
        items: [
          { name: '롱펄스 Nd:YAG', note: '혈관병변·다리혈관 등' },
  ...
  },
  {
    ...
    subgroups: [
      ...
      },
      {
        title: '필러 · 부피 보충',
        items: [
          { name: '히알루론산(HA) 필러', note: '팔자·입술·턱·이마 등' },
          { name: '콜라겐 유도 필러', note: 'PLLA·PCL·CaHA 등 — 상품별 상이' },
          { name: 'PN·폴리뉴클레오타이드 필러', note: '재생·탄력 병합 목적' },
          { name: '지방이식 보조·윤곽', note: '내원 평가 후' },
        ],
      },
      {
        title: '스킨부스터 · 재생 주사',
        items: [
          { name: 'PN·폴리뉴클레오타이드', note: '리쥬란 등 상품군' },
          { name: '히알루론산 수분부스터' },
          { name: '멀티부스터·콤보 프로토콜', note: 'HA+비타민+항산화 등' },
          { name: '스킨바이브·수분 마이크로인젝션' },
          { name: '엑소좀·줄기세포 배양액 함유 제품', note: '허가 범위 내' },
          { name: 'PRP·PRF', note: '자가혈 소분' },
          { name: '글루타치온·비타민 미세주사', note: '피부톤·피로 보조' },
        ],
      },
      {
        title: '실 · 매립 리프팅',
        items: [
          { name: 'PDO 모노·코그 실', note: '얼굴선·볼처짐 보조' },
      ...
      },
      {
        title: '지방 · 바디 주사',
        items: [
          { name: '지방분해주사', note: '성분·부위별 — 부종·통증 개인차' },
      ...
      },
      {
        title: '메조테라피 · 미세 침습',
        items: [
          { name: '얼굴·목 메조', note: '약물·영양 칵테일' },
          { name: '두피 메조', note: '탈모 보조' },
          { name: '다크서클·눈가 미세주사' },
        ],
      },
      {
    ...
    subgroups: [
      {
        title: '비만 · 대사',
        items: [
          { name: 'GLP-1 수용체 작용제', note: '식욕·체중 관리 — 적응증·금기 엄수' },
          { name: '지방흡수 억제제(예: 오르리스타트)', note: '소화기 부작용 안내' },
      ...
      },
      {
        title: '탈모',
        items: [
          { name: '피나스테리드·두타스테리드', note: '남성형 — 여성 금기·임신 주의' },
          { name: '미녹시딜(경구)', note: '저용량 처방 — 혈압·부종 모니터' },
      ...
      },
      {
        title: '여드름 · 피지',
        items: [
          { name: '테트라사이클린계(독시·미노)', note: '햇빛·임신 금기' },
          { name: '아이소트레티노인', note: '중증 낭종성 — teratogenic, 간기능' },
    ...
    subgroups: [
      {
        title: '스테로이드 · 면역조절 외용',
        items: [
          { name: '약·중·약도 스테로이드 연고', note: '아토피·습진 — 단계적 감량' },
          { name: '타크로리무스·피메크로리무스', note: '면역억제 연고 — TCI' },
      ...
      },
      {
        ...
        items: [
          { name: '과산화벤조일 겔·크림' },
          { name: '아다팔렌·트레티노인·타자로텐', note: '자극 적응기' },
          { name: '클린다마이신·에리스로마이신 외용' },
          { name: '아젤라산 크림' },
          { name: '살리실산·글리콜산 로션', note: '각질·블랙헤드' },
        ],
      },
      {
        title: '색소 · 미백',
        items: [
          { name: '히드로퀴논 복합제', note: '기간 제한·자극' },
          { name: '트레티노인·히드로퀴논·스테로이드 삼제(Kligman)', note: '처방 전용' },
          { name: '아젤라산·비타민C 유도체' },
          { name: '알부틴·나이아신아마이드 화장품의약품 경계', note: '의료용 농도는 처방' },
        ],
      },
      {
        title: '보습 · 장벽',
      ...
      },
      {
        ...
        items: [
          ...
          { name: '케토코나졸 샴푸', note: '지루 병행' },
        ],
      },
      {
        title: '항진균 · 항바이러스 · 기타',
        items: [
          { name: '이미다졸·테르비나핀 외용', note: '무좀·피부사상균' },
          { name: '아시클로버 판크림', note: '단순포진' },
          { name: '이버멕틴 크림', note: '장티푸스 등 적응' },
          { name: '실리콘 겔·시트', note: '흉터·켈로이드 보조' },
        ],
      },
    ],
  },
