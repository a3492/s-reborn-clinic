...
그 시술을 받은 사람이 **지금 어떤 상태인가**입니다. after 사진에는 만족스럽게 찍은 한 순간이 있지만, 1년 후 그 부위가 어떻게 변했는지, 재시술이 필요해졌는지, 자연스럽게 유지되는지는 담겨 있지 않습니다.
...
다만 그 사진을 "이 사람처럼 되는 것"이 목표가 아니라, **"이 방향으로 가고 싶다"는 레퍼런스로 활용하는 것**이 맞습니다. 같은 시술도 얼굴 구조, 피부 상태, 기존 볼륨에 따라 결과가 달라지기 때문에, 그 사진 속 사람과 동일한 결과를 약속할 수 있는 의사는 없습니다.
